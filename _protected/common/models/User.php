...
class User extends UserIdentity
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'email', 'name', 'lastname'], 'required'],
            [['department', 'faculty'], 'string' ,'max' => 250],
            [['picture'], 'file', 'skipOnEmpty' => true,'extensions' => 'png,jpg' ],
            ['email', 'email'],
            ['password_md5','string', 'max' => 250],
            ...
            ['username', 'unique', 'message' => 'ชื่อนี้ถูกใช้งานแล้ว'],
            ['email', 'unique', 'message' => 'อีเมลล์นี้ถูกใช้งานแล้ว'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'department'  => Yii::t('app', 'ภาควิชา/สาขาวิชา'),
            'faculty'     => Yii::t('app', 'คณะ'),
...
//------------------------------------------------------------------------------------------------//
    ...
    public function uploadProfile($model, $attribute)
    {
    ...
    public function getUploadPath()
    {
        ...
        return   realpath(Yii::$app->basePath.'/../..').'/uploads';
    }
    ...
    public function getPictureViwer()
    {
       return empty($this->picture) ? Yii::getAlias('@uploads').'/people.png' : Yii::getAlias('@uploads').'/'.$this->picture;
    }

    public function pictureRemove($name)
    {
        $path        = $this->getUploadPath();
        $picturename = $name;
